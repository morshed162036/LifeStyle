    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo e(route('admin.dashboard')); ?>">
                        <div class="brand-logo"><img class="logo"
                                src="<?php echo e(asset('client/assets/img/logo/waawlogo.png')); ?>" /></div>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('catalogue.index')): ?>
    ...
    <!-- END: Main Menu-->
<?php /**PATH /home/zariijsr/ecom.zariq.com.bd/resources/views/server/layout/menu-bar.blade.php ENDPATH**/ ?>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12">
                    <div class="copyright_area text-center">
                        <p>&copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(route('client.home')); ?>" class="text-uppercase">waaw fashion</a>.
                            Technical Support <i
                                class="fa fa-heart"></i> by <a target="_blank"
                                                               href="https://www.zariq.com.bd" style="color: blue">Zariq
                                ltd</a></p>
                    </div>
                    <div class="col-lg-12 col-md-12">
...
<?php /**PATH /home/zariijsr/ecom.zariq.com.bd/resources/views/client/layouts/footer.blade.php ENDPATH**/ ?>
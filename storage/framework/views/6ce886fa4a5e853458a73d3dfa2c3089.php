                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-content">
                                <form action="<?php echo e(Route('stock.variantUpdate',$variant->id)); ?>" method="post"> <?php echo csrf_field(); ?>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <fieldset>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" aria-describedby="basic-Createon1" value="<?php echo e($variant->product->title); ?>" readonly>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <h5>Size</h5>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" aria-describedby="basic-Createon1" value="<?php echo e($variant->productvariation->size); ?>" readonly>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <h5>New Stock</h5>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" aria-describedby="basic-Createon1" name="quantity" required>
                                                    </div>
                                                </fieldset>
...
<?php echo $__env->make('server.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zariijsr/ecom.zariq.com.bd/resources/views/server/stock/edit-details.blade.php ENDPATH**/ ?>
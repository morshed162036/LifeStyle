                            ...
                            <div class="card-body card-dashboard">
                                <div class="table-responsive">
                                    <table class="table zero-configuration">
                                        ...
                                        <tbody>
                                            @if ($catalogues)
                                                @foreach ($catalogues as $catelogue)
                                                    <tr>
                                                        <td>{{ $catelogue->name }}</td>
                                                        <td>
                                                            @if($catelogue->status == 'Active')
                                                                <a class="updateCatalogueStatus" id="catalogue-{{ $catelogue->id }}"
                                                                    catalogue_id = "{{ $catelogue->id }}"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('catalogue.edit',$catelogue->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    {{-- <form action="{{ route('catalogue.destroy',$catelogue->id) }}" method="post"> @csrf @method('Delete')

                        ...
                        <div class="card-header">
                            ...
                            {{-- <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="{{ route('banner.create') }}" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div> --}}
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table zero-configuration">
                                        ...
                                        <tbody>
                                            @if ($details)
                                                    <tr>
                                                        <td><img src="{{ asset('images/company/'.$details->logo) }}" alt="" height="80px"></td>
                                                        <td><img src="{{ asset('images/company/'.$details->favicon) }}" alt="" height="50px"></td>
                                                        <td><img src="{{ asset('images/company/'.$details->size_guide) }}" alt="" height="200px"></td>
                                                        <td>Phone:{{ $details->phone }} <br>
                                                            Email:{{ $details->email }}
                                                        </td>
                                                        <td>{{ $details->support_hour }}</td>
                                                        <td>{{ $details->facebook }}</td>
                                                        <td>{{ $details->youtube }}</td>
                                                        <td>{{ $details->instagram }}</td>
                                                        <td>{{ $details->fb_order }}</td>
                                                        <td>{{ $details->youtube_order }}</td>
                                                        <td>{{ $details->insta_order }}</td>
                                                        <td>
                                                            <div class="dropdown">
                                                                <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('company-details.edit',$details->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>

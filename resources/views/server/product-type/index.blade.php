                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="{{ route('product-type.create') }}" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($banner->status == 'Active')
                                                                <a class="updateProductTypeStatus" id="product_type-{{ $banner->id }}"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('product-type.edit',$banner->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    <form action="{{ route('product-type.destroy',$banner->id) }}" method="post"> @csrf @method('Delete')
        ...
        $(document).ready(function (){
            $(document).on("click", ".updateProductTypeStatus", function () {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "{{ route('updateProductTypeStatus') }}",

                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="view_section" id="" class="form-control" required>
                                                    <option @if ($product->view_section == 'New_Arrival')
                                                        selected
                                                    @endif value="New_Arrival">New Arrival</option>
                                                    <option @if ($product->view_section == 'Feature_Products')
                                                        selected
                                                    @endif value="Feature_Products">Feature Products</option>
                                                    <option @if ($product->view_section == 'Most_Popular')
                                                        selected
                                                    @endif value="Most_Popular">Most Popular</option>
                                                    <option @if ($product->view_section == 'Best_Seller')
                                                        selected
                                                    @endif value="Best_Seller">Best Seller</option>
                                                    <option @if ($product->view_section == 'Flash Sell')
                                                        selected
                                                    @endif value="Flash_Sell">Flash Sell</option>
                                                    <option @if ($product->view_section == 'Speacial_Offer')
                                                        selected
                                                    @endif value="Speacial_Offer">Speacial Offer</option>
                                                    <option @if ($product->view_section == 'Trending_Products')
                                                        selected
                                                    @endif value="Trending_Products">Trending Products</option>
                                                </select>
                                            </div>
                                        </fieldset>
                                        {{-- <fieldset class="mt-2">

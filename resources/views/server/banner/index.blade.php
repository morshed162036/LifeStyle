                                        ...
                                        <tbody>
                                            @if ($banners)
                                                @foreach ($banners as $banner)
                                                    <tr>
                                                        <td class="text-bold-600" ><img src="{{ asset('images/banner/'.$banner->image) }}" alt="" height="150px"></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('banner.edit',$banner->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    <form action="{{ route('banner.destroy',$banner->id) }}" method="post"> @csrf @method('Delete')

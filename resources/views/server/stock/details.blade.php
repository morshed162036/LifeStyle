                                        ...
                                        <tbody>
                                            @if ($variants)
                                                @foreach ($variants as $variant)
                                                    <tr>
                                                        <td class="text-primary">{{ $variant->product->title}}</td>
                                                        <td class="text-primary">{{ $variant->productvariation->size}}</td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                        ...
                                                                        <a class="dropdown-item" href="{{ route('stock.variantEdit',$variant->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>

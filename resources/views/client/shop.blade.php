...
{{--                                    <li class="widget_sub_categories"><a href="{{ url('shop/catalogue/'.$catalogue->id) }}">{{ $catalogue->name }}</a>--}}
{{--                                        @if ($catalogue->category)--}}
{{--                                            @foreach ($catalogue->category as $category)--}}
{{--                                            <ul class="widget_dropdown_categories">--}}
{{--                                                <li class="widget_sub_categories mx-4"><a href="{{ url('shop/category/'.$category->id) }}">{{ $category->name }}</a>--}}
{{--                                                    @if ($category->subcategories)--}}
{{--                                                        @foreach ($category->subcategories as $subcategories)--}}
{{--                                                            <ul class="widget_dropdown_categories">--}}
{{--                                                                <li class="mx-4"><a href="{{ url('shop/category/'.$subcategories->id) }}">{{ $subcategories->name }}</a></li>--}}
{{--                                                            </ul>--}}
{{--                                                        @endforeach--}}
{{--                                                    @endif--}}
{{--                                                </li>--}}
